...
ntuple_clusters = cms.PSet(
    ...
    Clusters = cms.InputTag('hgcalTriggerPrimitiveDigiProducer', 'cluster2D', 'HLT'),
    Multiclusters = cms.InputTag('hgcalTriggerPrimitiveDigiProducer', 'cluster3D', 'HLT'),
...
hgcalTriggerNtuplizerReadOnlyAll = cms.EDAnalyzer(
